...
const MapComponent = () => {
  ...
  const [clickedSchool, setClickedSchool] = useState<string | null>(null);
  ...
  return (
    <div className="block md:hidden z-0">
        ...
        <g clip-path="url(#clip0_2046_3404)">
          ...
          <>
            <path
              ...
              fill={clickedSchool === "lincoln" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "lincoln" ? setClickedSchool(null) : setClickedSchool("lincoln")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "academy" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "academy" ? setClickedSchool(null) : setClickedSchool("academy")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "sota" ? "black" : "#3A86FF"}
          ...
          <>
            <path
              ...
              fill={clickedSchool === "washington" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "washington" ? setClickedSchool(null) : setClickedSchool("washington")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "independence" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "independence" ? setClickedSchool(null) : setClickedSchool("independence")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "balboa" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "balboa" ? setClickedSchool(null) : setClickedSchool("balboa")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "lowell" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "lowell" ? setClickedSchool(null) : setClickedSchool("lowell")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "june" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "june" ? setClickedSchool(null) : setClickedSchool("june")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "burton" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "burton" ? setClickedSchool(null) : setClickedSchool("burton")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "marshall" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "marshall" ? setClickedSchool(null) : setClickedSchool("marshall")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "downtown" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "downtown" ? setClickedSchool(null) : setClickedSchool("downtown")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "international" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "international" ? setClickedSchool(null) : setClickedSchool("international")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "oconnell" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "oconnell" ? setClickedSchool(null) : setClickedSchool("oconnell")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "mission" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "mission" ? setClickedSchool(null) : setClickedSchool("mission")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "wells" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "wells" ? setClickedSchool(null) : setClickedSchool("wells")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "wallenberg" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "wallenberg" ? setClickedSchool(null) : setClickedSchool("wallenberg")}
            />
            <path
          ...
          <>
            <path
              ...
              fill={clickedSchool === "galileo" ? "black" : "#3A86FF"}
              onMouseDown={() => clickedSchool === "galileo" ? setClickedSchool(null) : setClickedSchool("galileo")}
      ...
      {clickedSchool === "burton" && (
        <MapCard
          name="Phillip and Sala Burton High School"
          district="Portola"
          students="134"
          frl="75"
          ell="22.4"
      ...
      {clickedSchool === "june" && (
        <MapCard
          name="June Jordan School of Equity"
          district="Excelsior"
          students="324"
          frl="65"
          ell="48"
