...
const MapComponent = () => {
  ...
  return (
    <div className="block md:hidden z-0">
      ...
      >
        <g clip-path="url(#clip0_2046_3404)">
          ...
          <path
            ...
            fill={hoveredSchool === '8' ? 'black' : "#3A86FF"}
            onClick={() => setHoveredSchool('8')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '12' ? 'black' : "#3A86FF"}
            onClick={() => setHoveredSchool('12')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '5' ? 'black' : "#3A86FF"}
            onClick={() => setHoveredSchool('5')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '16' ? 'black' : "#FF7700"}
            onClick={() => setHoveredSchool('16')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '0' ? 'black' : "#FF7700"}
            onClick={() => setHoveredSchool('0')}
          ...
          <path
            ...
            fill={hoveredSchool === '9' ? 'black' : "#3A86FF"}
            onClick={() => setHoveredSchool('9')}
          ...
          />
          <path
            // City and Arts Tech high school
            ...
            fill={hoveredSchool === '7' ? 'black' : "#EA4335"}
            onClick={() => setHoveredSchool('7')}
          ...
          <path
            ...
            fill={hoveredSchool === '1' ? 'black' : "#EA4335"}
            onClick={() => setHoveredSchool('1')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '14' ? 'black' : "#EA4335"}
            onClick={() => setHoveredSchool('14')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '6' ? 'black' : "#FF7700"}
            onClick={() => setHoveredSchool('6')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '11' ? 'black' : "#FF7700"}
            onClick={() => setHoveredSchool('11')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '10' ? 'black' : "#EA4335"}
            onClick={() => setHoveredSchool('10')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '4' ? "black" : "#FF7700"}
            onClick={() => setHoveredSchool('4')}
          />
          <path
          ...
          <path
            ...
            fill={hoveredSchool === '15' ? "black" : "#FF7700"}
            onClick={() => setHoveredSchool('15')}
          />
          <path
          ...
          <>
            <path
              ...
              fill={hoveredSchool === '3' ? "black" : "#FF7700"}
              onClick={() => setHoveredSchool("3")}
            />
            <path
      ...
      {hoveredSchool && (
              <MapCard 
                  name={`${schools[parseInt(hoveredSchool)].name}`} 
                  district={`${schools[parseInt(hoveredSchool)].district}`} 
                  students={`${schools[parseInt(hoveredSchool)].students}`} 
                  frl={`${schools[parseInt(hoveredSchool)].frl}`} 
                  ell={`${schools[parseInt(hoveredSchool)].ell}`} 
                  img={`${schools[parseInt(hoveredSchool)].img}`}
              />
      )}
    </div>
  );
