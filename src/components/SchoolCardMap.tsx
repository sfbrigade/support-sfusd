...
const SchoolCard: React.FC<SchoolCardProps> = ({ school }) => {
  return (
    <div className="flex flex-col items-center justify-center p-4 bg-white border border-gray-300 rounded-lg max-w-[400px] max-h-[400px]">
      ...
      <h3 className="text-lg mb-2 text-slate-400">{school.district} District</h3>
      <div className="flex flex-row items-center">
        ...
        />
        <h3 className="text-lg">{school.students  ? school.students : "N/A"} Students</h3>
      </div>
      <div className="flex flex-row items-center">
        <img
          ...
          className="max-w-[40px] max-h-[40px] mr-2"
        />
        <h3 className="text-lg">{school.frl  ? school.frl : "N/A"}% Free and Reduced Lunch</h3>
      </div>
      <div className="flex flex-row items-center">
        <img
          ...
          className="max-w-[40px] max-h-[40px] mr-2"
        />
        <h3 className="text-lg">{school.ell  ? school.ell : "N/A"}% English Language Learners</h3>
      </div>
