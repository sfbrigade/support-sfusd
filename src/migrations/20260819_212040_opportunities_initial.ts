...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "payload"."opportunities" ADD CONSTRAINT "opportunities_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "payload"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "opportunities_image_idx" ON "payload"."opportunities" USING btree ("image_id");
